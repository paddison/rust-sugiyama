...
mod feasible_tree_builder {
    use crate::graphs::p1_layering::{start_layering, FeasibleTreeBuilder, tree::Tree, rank::tests::create_test_ranking_not_tight};

    use super::create_test_graph;

    fn create_test_builder() -> FeasibleTreeBuilder<isize> {
        let tree = Tree::from_edges(&[(0, 1), (1, 2), (2, 3), (3, 7), (4, 6), (5, 6), (6, 7)]);
        let mut graph = create_test_graph();
